<template>
  <div
    class="card-border w-full sm:w-[460px] p-6 flex flex-col gap-4 transition-transform hover:scale-[1.02]"
  >
    ...
    <div v-if="project.technologies.length > 0" class="flex flex-wrap gap-3 items-center">
      <div
